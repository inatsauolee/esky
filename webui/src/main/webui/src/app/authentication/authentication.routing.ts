...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'login', component: PageLoginComponent, data: { title: 'SYNAPS | Login' } },
            { path: 'register', component: PageRegisterComponent, data: { title: 'SYNAPS | Register' } },
            { path: 'lockscreen', component: PageLockscreenComponent, data: { title: 'SYNAPS | Lock Screen' } },
            { path: 'forgot-password', component: PageForgotPasswordComponent, data: { title: 'SYNAPS | Forgot Password' } },
